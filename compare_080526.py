"""Compare generated 08.05.26 report vs reference master."""
import openpyxl, pandas as pd

GEN        = r"C:\Project_AI\network-path-finder-project\reports_output\DAILY_CPAN_REPORTS_08.05.26_PY.xlsx"
REF_MASTER = r"C:\Project_AI\network-path-finder-project\08.05.26\DAILY_CPAN_REPORTS_MASTER_08.05.26.xlsx"
...
print("=" * 70)
print("COMPARISON: Generated vs Reference - 08.05.26")
print("=" * 70)
...
for sh_name in SHEETS:
    ...
    if only_ref and len(only_ref) > 1:
...
print("SUMMARY")
print("=" * 70)
print("GEN row counts: CARD-OFF-R=30  DEVICE-OFF-R=46  FAN-FAIL-R=43  DL-FAIL-R=99")
